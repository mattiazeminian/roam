 ...
 */
export function RouteOptions({ routes, selectedIndex, onSelect }: RouteOptionsProps) {
  return (
  ...
  return (
    <Animated.View style={[styles.item, press.animatedStyle]}>
      <Pressable
        ...
        accessibilityLabel={`Route ${index + 1} of ${count}, ${fmt.distance(route.distanceKm * 1000)} ${fmt.unitSpoken}, about ${route.estimatedMinutes} minutes`}
        style={({ pressed }) => [
          styles.card,
          {
