...
import { findBrand } from '@/services/shoe-catalog';
import {
  loadShoes,
  removeShoe,
  saveShoes,
  ...
  return (
    <Pressable
      ...
      <Card padded={false} style={styles.shoeCard}>
        <View
          style={[styles.shoeTile, { backgroundColor: theme.fill }]}
          accessibilityLabel={`${shoe.brand} brand mark`}>
          <BrandMark brand={findBrand(shoe.brandKey)} fallbackName={shoe.brand} size={44} />
        </View>
