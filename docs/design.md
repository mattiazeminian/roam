...
> **Reference, not the current system.** This is the analysis the original
> palette was derived from. ROAM's own visual language is described in
> `design-system.md` and `brand.md`, and the route/map treatment in
> `map-style.md`.
